...
<body>
          ...
          <div class="section-header">
            ...
            <h1>
              ...
              <?php if (!$this->ion_auth->in_group(3)) { ?>
                <a href="#" id="modal-add-products" class="btn btn-sm btn-icon icon-left btn-primary"><i
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><?= $this->lang->line('products') ? $this->lang->line('products') : 'Products' ?>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card card-primary">
                  <div class="card-body">
                    <table class='table-striped' id='products_list' data-toggle="table"
                      data-url="<?= base_url('products/get_products') ?>" data-click-to-select="true"
                      data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]"
                      data-search="true" data-show-columns="true" data-show-refresh="false" data-trim-on-search="false"
                      ...
                      <thead>
                        <tr>
                          <th data-field="name" data-sortable="name">
                            <?= $this->lang->line('name') ? $this->lang->line('name') : 'Name' ?></th>
                          <th data-field="description" data-sortable="true">
                            <?= $this->lang->line('description') ? $this->lang->line('description') : 'Description' ?></th>
                          <th data-field="price" data-sortable="true">
                            <?= $this->lang->line('price') ? $this->lang->line('price') : 'Price' ?> -
                            <?= get_currency('currency_code') ?></th>
  ...
  <form action="<?= base_url('products/create') ?>" method="POST" class="modal-part" id="modal-add-products-part"
    ...
    <div class="form-group">
      <label><?= $this->lang->line('price') ? $this->lang->line('price') : 'Price' ?> - <?= get_currency('currency_code') ?>
  ...
  <form action="<?= base_url('products/edit') ?>" method="POST" class="modal-part" id="modal-edit-products-part"
