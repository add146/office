...
<body>
          ...
          <div class="row">
              ...
              <div class="card  card-primary ard-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title">
                    <?= $this->lang->line('project_statistics') ? $this->lang->line('project_statistics') : 'Project Statistics' ?>
                    -
                    <div class="dropdown d-inline">
                      <a
                        href="<?= base_url('projects') ?>"><?= $this->lang->line('view') ? $this->lang->line('view') : 'View' ?></a>
                    </div>
                  </div>
                  <div class="card-stats-items mb-3">
                    <div class="card-stats-item text-danger">
                      ...
                      <div class="card-stats-item-label">
                        <?= $this->lang->line('pending') ? $this->lang->line('pending') : 'Pending' ?></div>
                    </div>
                    <div class="card-stats-item text-success">
                      ...
                      <div class="card-stats-item-label">
                        <?= $this->lang->line('completed') ? $this->lang->line('completed') : 'Completed' ?></div>
                    </div>
                    <div class="card-stats-item">
                      ...
                      <div class="card-stats-item-label">
                        <?= $this->lang->line('total') ? $this->lang->line('total') : 'Total' ?></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card  card-primary card-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title">
                    <?= $this->lang->line('tasks_statistics') ? $this->lang->line('tasks_statistics') : 'Tasks Statistics' ?>
                    -
                    <div class="dropdown d-inline">
                      <a
                        href="<?= base_url('projects/tasks') ?>"><?= $this->lang->line('view') ? $this->lang->line('view') : 'View' ?></a>
                ...
                <div class="card card-primary card-statistic-2">
                  <div class="card-stats">
                    <div class="card-stats-title">
                      ...
                      (<?= get_currency('currency_symbol') ?>)</div>
                    <div class="card-stats-items mb-3">
                      <div class="card-stats-item text-danger">
                        <div class="card-stats-item-count"><?= format_currency($get_my_invoices_details['due'], false) ?>
                        </div>
                        <div class="card-stats-item-label"><?= $this->lang->line('due') ? $this->lang->line('due') : 'Due' ?>
                        </div>
                      </div>
                      <div class="card-stats-item text-success">
                        <div class="card-stats-item-count"><?= format_currency($get_my_invoices_details['paid'], false) ?>
                        </div>
                        <div class="card-stats-item-label"><?= $this->lang->line('paid') ? $this->lang->line('paid') : 'Paid' ?>
                        </div>
                      </div>
                      <div class="card-stats-item text-primary">
                        <div class="card-stats-item-count"><?= format_currency($get_my_invoices_details['total'], false) ?>
                        </div>
                        <div class="card-stats-item-label">
                          <?= $this->lang->line('total') ? $this->lang->line('total') : 'Total' ?></div>
                      </div>
                  ...
                  <div class="card-wrap">
                    <?php if ($my_att_running) { ?>
                      <div class="card-header">
                        <h4>
                          <?= $this->lang->line('check_in_at') ? htmlspecialchars($this->lang->line('check_in_at')) : 'You checked in at' ?>
                          <?= format_date($my_att_running[0]['check_in'], system_date_format() . " " . system_time_format()); ?>
                        </h4>
                      </div>
                      <div class="card-body">
                    ...
                    <?php } else { ?>
                      <div class="card-header">
                        <h4>
                          <?= $this->lang->line('you_are_currently_checked_out') ? htmlspecialchars($this->lang->line('you_are_currently_checked_out')) : 'You are currently checked out' ?>
                        </h4>
                      </div>
                      <div class="card-body">
                        <a class="btn btn-sm btn-outline-danger" href="<?= base_url('attendance/in-out') ?>">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 col-12 col-sm-12">
              <div class="card card-primary">
                <div class="card-header">
                  <h4>
                    <?= $this->lang->line('project_statistics') ? htmlspecialchars($this->lang->line('project_statistics')) : 'Project Statistics' ?>
                  </h4>
                </div>
                <div class="card-body">
  ...
  <form action="<?= base_url('meetings/edit') ?>" method="POST" class="modal-part" id="modal-edit-meetings-part"
    data-title="<?= $this->lang->line('edit') ? $this->lang->line('edit') : 'Edit' ?>"
    data-btn="<?= $this->lang->line('update') ? $this->lang->line('update') : 'Update' ?>">

    <input type="hidden" name="update_id" id="update_id">

    <div class="form-group">
      <label><?= $this->lang->line('title') ? $this->lang->line('title') : 'Title' ?><span
          class="text-danger">*</span></label>
      <input type="text" name="title" id="title" class="form-control" required="">
    </div>

    <div class="form-group">
      <label><?= $this->lang->line('starting_time') ? $this->lang->line('starting_time') : 'Starting Time' ?><span
          class="text-danger">*</span></label>
      <input type="text" name="starting_date_and_time" id="starting_date_and_time" class="form-control datetimepicker">
    </div>
    <div class="form-group">
      <label><?= $this->lang->line('duration') ? $this->lang->line('duration') : 'Duration (Minutes)' ?><span
          class="text-danger">*</span></label>
      <input type="number" pattern="[0-9]" name="duration" id="duration" class="form-control">
    </div>

    <div class="form-group">
      <label><?= $this->lang->line('users') ? $this->lang->line('users') : 'Users' ?><span
          class="text-danger">*</span></label>
