          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">
                <a
                  href="<?= base_url('estimates') ?>"><?= $this->lang->line('estimates') ? $this->lang->line('estimates') : 'Estimates' ?></a>
              </div>
              <div class="breadcrumb-item">
            ...
            <div class="row mb-4">
              <div class="col-lg-12">
                <?php if ($this->ion_auth->in_group(3) && $estimate[0]['status'] == 1) { ?>
                  <a href="<?= base_url('estimates/accept/' . $estimate[0]['id']) ?>"
                    class="btn btn-success btn-icon icon-left"><i class="fas fa-check"></i>
                    <?= $this->lang->line('accept') ? $this->lang->line('accept') : 'Accept' ?></a>
                  <a href="<?= base_url('estimates/reject/' . $estimate[0]['id']) ?>"
                    class="btn btn-danger btn-icon icon-left"><i class="fas fa-times"></i>
                    <?= $this->lang->line('reject') ? $this->lang->line('reject') : 'Reject' ?></a>
                <?php } ?>
                <a href="<?= base_url('estimates/generate-pdf/' . $estimate[0]['id']) ?>"
                  class="btn btn-warning btn-icon icon-left" target="_blank"><i class="fas fa-print"></i>
                    ...
                    <div class="row mt-4">
                      ...
                      <div class="col-lg-5 text-right">
                        <div class="invoice-detail-item">
                          ...
                          <div class="invoice-detail-value"><?= format_currency($estimate[0]['amount']) ?></div>
                        </div>
                        <?php if ($taxes) {
