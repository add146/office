        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item active"><a
                  href="<?= base_url('projects') ?>"><?= $this->lang->line('projects') ? $this->lang->line('projects') : 'Projects' ?></a>
              </div>
              <div class="breadcrumb-item"><?= $this->lang->line('details') ? $this->lang->line('details') : 'Details' ?>
              </div>
            </div>
          </div>
          <div class="section-body">
            ...
            <?php if ($this->ion_auth->is_admin() || permissions('task_view')) { ?>
              <a href="<?= base_url("projects/tasks/" . htmlspecialchars($project['id'])) ?>"
                class="btn btn-icon icon-left btn-primary"><i class="fas fa-tasks"></i>
                <?= $this->lang->line('tasks') ? $this->lang->line('tasks') : 'Tasks' ?></a>
            <?php } ?>


            <?php if ($this->ion_auth->is_admin() || permissions('calendar_view')) { ?>
              <a href="<?= base_url("projects/calendar/" . htmlspecialchars($project['id'])) ?>"
                class="btn btn-icon icon-left btn-primary"><i class="fas fa-calendar-alt"></i>
                <?= $this->lang->line('calendar') ? $this->lang->line('calendar') : 'Calendar' ?></a>
            <?php } ?>

            <?php if ($this->ion_auth->is_admin() || permissions('gantt_view')) { ?>
              <a href="<?= base_url("projects/gantt/" . htmlspecialchars($project['id'])) ?>"
                class="btn btn-icon icon-left btn-primary"><i class="fas fa-layer-group"></i>
                <?= $this->lang->line('gantt') ? $this->lang->line('gantt') : 'Gantt' ?></a>
            <?php } ?>

            <?php if (!$this->ion_auth->in_group(3)) { ?>
              <a href="<?= base_url("projects/timesheet/" . htmlspecialchars($project['id'])) ?>"
                class="btn btn-icon icon-left btn-primary"><i class="fas fa-stopwatch"></i>
                <?= $this->lang->line('timesheet') ? $this->lang->line('timesheet') : 'Timesheet' ?></a>
            <?php } ?>

            <?php if ($this->ion_auth->is_admin() || permissions('project_edit')) { ?>
              <a href="#" data-edit="<?= htmlspecialchars($project['id']) ?>"
                class="btn btn-icon icon-left btn-info modal-edit-project"><i class="fas fa-edit"></i>
                <?= $this->lang->line('edit') ? $this->lang->line('edit') : 'Edit' ?></a>
            <?php } ?>

            <?php if ($this->ion_auth->is_admin() || permissions('project_delete')) { ?>
              <a href="#" class="btn btn-icon icon-left btn-danger delete_project"
                data-id="<?= htmlspecialchars($project['id']) ?>"><i class="fas fa-times"></i>
                <?= $this->lang->line('delete') ? $this->lang->line('delete') : 'Delete' ?></a>
            <?php } ?>
            ...
            <div class="row mt-3">
              <div class="col-md-7">
                <div class="card author-box card-<?= htmlspecialchars($project['project_class']) ?>">
                  <div class="card-body">
                    ...
                    <div class="author-box-job text-<?= htmlspecialchars($project['project_class']) ?>">
                      <?= htmlspecialchars($project['project_status']) ?></div>
                          ...
                          <div class="profile-widget-items">
                            <div class="profile-widget-item">
                              <div class="profile-widget-item-label">
                                <?= $this->lang->line('name') ? $this->lang->line('name') : 'Name' ?></div>
                              <div class="profile-widget-item-value">
                                <?= htmlspecialchars($project['project_client']->first_name) ?>
                                <?= htmlspecialchars($project['project_client']->last_name) ?></div>
                            </div>
                            <div class="profile-widget-item">
                              <div class="profile-widget-item-label">
                                <?= $this->lang->line('company_name') ? $this->lang->line('company_name') : 'Company Name' ?>
                              </div>
                              <div class="profile-widget-item-value">
                                <?= htmlspecialchars($project['project_client']->company) ?></div>
                            </div>
                          </div>
                        </div>
                        <div class="profile-widget-header">
                          <div class="profile-widget-items">
                            <div class="profile-widget-item">
                              <div class="profile-widget-item-label">
                                <?= $this->lang->line('email') ? $this->lang->line('email') : 'Email' ?></div>
                              <div class="profile-widget-item-value">
                                <?= htmlspecialchars($project['project_client']->email) ?></div>
                            </div>
                            <div class="profile-widget-item">
                              <div class="profile-widget-item-label">
                                <?= $this->lang->line('mobile') ? $this->lang->line('mobile') : 'Mobile' ?></div>
                              <div class="profile-widget-item-value">
                                <?= htmlspecialchars($project['project_client']->phone) ?></div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="profile-widget mt-0">
                      <div class="profile-widget-header">
                        <div class="profile-widget-items">
                          <div class="profile-widget-item">
                            <div class="profile-widget-item-label">
                              <?= $this->lang->line('days') ? $this->lang->line('days') : 'Days' ?>
                              <?= htmlspecialchars($project['days_status']) ?></div>
                            <div class="profile-widget-item-value"><?= htmlspecialchars($project['days_count']) ?></div>
                          </div>
                          <div class="profile-widget-item">
                            <div class="profile-widget-item-label">
                              <?= $this->lang->line('starting_date') ? $this->lang->line('starting_date') : 'Starting Date' ?>
                            </div>
                            <div class="profile-widget-item-value"><?= htmlspecialchars($project['starting_date']) ?>
                            </div>
                          </div>
                          <div class="profile-widget-item">
                            <div class="profile-widget-item-label">
                              <?= $this->lang->line('ending_date') ? $this->lang->line('ending_date') : 'Ending Date' ?></div>
                      ...
                      <div class="profile-widget-header">
                        <div class="profile-widget-items">
                          <div class="profile-widget-item">
                            <div class="profile-widget-item-label">
                              <?= $this->lang->line('total_tasks') ? $this->lang->line('total_tasks') : 'Total Tasks' ?></div>
                            <div class="profile-widget-item-value"><?= htmlspecialchars($project['total_tasks']) ?></div>
                          </div>
                          <div class="profile-widget-item">
                            <div class="profile-widget-item-label">
                              <?= $this->lang->line('completed_tasks') ? $this->lang->line('completed_tasks') : 'Completed Tasks' ?>
                            </div>
                            <div class="profile-widget-item-value"><?= htmlspecialchars($project['completed_tasks']) ?>
                            </div>
                          </div>
                          <div class="profile-widget-item">
                            <div class="profile-widget-item-label">
                              <?= $this->lang->line('pending_tasks') ? $this->lang->line('pending_tasks') : 'Pending Tasks' ?>
                            </div>
                            <div class="profile-widget-item-value">
                              <?= htmlspecialchars($project['total_tasks']) - htmlspecialchars($project['completed_tasks']) ?>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="col-md-6">
                <div class="card card-primary">
                  <div class="card-header">
                    <h4><?= $this->lang->line('project') ? htmlspecialchars($this->lang->line('project')) : 'Project' ?>
                      <?= $this->lang->line('progress') ? htmlspecialchars($this->lang->line('progress')) : 'Progress' ?></h4>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-md-12">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <table class='table-striped' id='users_list' data-toggle="table"
                      data-url="<?= base_url('projects/get_project_users/' . $project['id']) ?>" data-click-to-select="true"
                      data-side-pagination="server" data-pagination="false" data-page-list="[5, 10, 20, 50, 100, 200]"
                      data-search="false" data-show-columns="false" data-show-refresh="false"
                      data-trim-on-search="false" data-sort-name="first_name" data-sort-order="asc"
                      ...
                      <thead>
                        <tr>
                          <th data-field="full_name" data-sortable="true">
                            <?= $this->lang->line('name') ? $this->lang->line('name') : 'Name' ?></th>
                          <th data-field="email" data-sortable="true">
                            <?= $this->lang->line('email') ? $this->lang->line('email') : 'Email' ?></th>
                        </tr>
                      </thead>
                    </table>
                  </div>
              ...
              <div class="col-md-6">
                <div class="card card-primary">
                  <div class="card-header">
                    <h4>
                      <?= $this->lang->line('upload_project_files') ? $this->lang->line('upload_project_files') : 'Upload Project Files' ?>
                    </h4>
                  </div>
                  <div class="card-body">
                    <form action="<?= base_url('projects/upload-files/' . htmlspecialchars($project['id'])) ?>"
              ...
              <div class="col-md-6">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <table class='table-striped' id='file_list' data-toggle="table"
                      ...
                      data-show-refresh="false" data-trim-on-search="false" data-sort-name="first_name"
                      data-sort-order="asc" data-mobile-responsive="true" data-toolbar="" data-show-export="false"
                      data-maintain-selected="true" data-export-types='["txt","excel"]' data-export-options='{
                        "fileName": "users-list",
                        "ignoreColumn": ["state"] 
                      }' data-query-params="queryParams">
                      <thead>
                        <tr>
                          <th data-field="file_name" data-sortable="true">
                            <?= $this->lang->line('file') ? $this->lang->line('file') : 'File' ?></th>
                          <th data-field="file_type" data-sortable="true">
                            <?= $this->lang->line('file_type') ? $this->lang->line('file_type') : 'File Type' ?></th>
                          <th data-field="file_size" data-sortable="true">
                            <?= $this->lang->line('size') ? $this->lang->line('size') : 'Size' ?></th>
                          <th data-field="action" data-sortable="false">
                            <?= $this->lang->line('action') ? $this->lang->line('action') : 'Action' ?></th>
                        </tr>
                      </thead>
                    </table>
                  </div>
              ...
              <div class="col-md-12">
                <div class="card card-primary" id="project-comment-card">
                  ...
                  <div class="card-body">
                        ...
                        <ul class="list-unstyled list-unstyled-border mt-3">
                          <li class="media"><?= $profile ?>
                            <div class="media-body">
                              ...
                              <div class="media-title"><?= $project_comment['first_name'] ?>
                                <?= $project_comment['last_name'] ?></div><?= $can_delete ?>
                    ...
                    <form action="<?= base_url('projects/create-project-comment') ?>" method="POST"
                      id="project-comment-form">
                      <div class="p-0 d-flex">
                        <input type="hidden" name="comment_project_id" value="<?= $project['id'] ?>">
                        <input type="text" name="message" id="message" class="form-control"
                          placeholder="<?= $this->lang->line('type_your_message') ? $this->lang->line('type_your_message') : 'Type your message' ?>">
  ...
  <form action="<?= base_url('projects/edit-project') ?>" method="POST" class="modal-part" id="modal-edit-project-part"
    ...
    <div class="form-group">
      ...
      <select name="client" id="client" class="form-control select2">
        <option value=""><?= $this->lang->line('select_clients') ? $this->lang->line('select_clients') : 'Select Clients' ?>
        </option>
        <?php foreach ($system_clients as $system_client) { ?>
          <option value="<?= htmlspecialchars($system_client->id) ?>"><?= htmlspecialchars($system_client->first_name) ?>
            <?= htmlspecialchars($system_client->last_name) ?></option>
        <?php } ?>
      </select>
    </div>
  </form>
