...
/**
 * Format currency with thousand separator and space after symbol
 * @param mixed $amount The amount to format
 * @param bool $with_symbol Whether to include currency symbol
 * @return string Formatted currency string
 */
function format_currency($amount, $with_symbol = true)
{
    // Convert to number if string
    $amount = floatval($amount);

    // Format with dot as thousand separator, comma as decimal (Indonesian style)
